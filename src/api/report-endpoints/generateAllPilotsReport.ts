...
import { GenerateAllPilotsReportProps } from "../../typescript/types/type";

const generateAllPilotsPdf = (props: GenerateAllPilotsReportProps) => {
    try {
        axios.post(`${baseURL}/report/generateAllPilotsPdf`, { userId: props.userId })
        .then((res) => {
...
export default generateAllPilotsPdf;
